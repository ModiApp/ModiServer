import createGameStateManager, { generateInitialGameState } from '../src/GameStateManager';
...
describe('GameStateManager tests', () => {
  ...
  test('when requested version is out of bounds, returns latest version', () => {
    ...
    expect(requestOutOfBoundsState()).toStrictEqual(generateInitialGameState(playerIds));
  })
});